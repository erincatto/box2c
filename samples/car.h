...
public:
	...
	void Spawn(b2WorldId worldId, b2Vec2 position, float scale, float hertz,
...
public:
	...
	void Spawn( b2WorldId worldId, b2Vec2 position, float scale, float hertz, float dampingRatio, float torque, float density, void* userData );
	void Despawn();
